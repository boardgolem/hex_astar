...
func astar_connect_walkable_cells(points_array):
	for point in points_array:
		...
		var points_relative = PoolVector2Array([
			point + Vector2(-1,0), 	#west
			point + Vector2(-1,-1),	#northwest
			point + Vector2(-1,+1),	#southwest
			point + Vector2(1,0), 	#east
			point + Vector2(0,-1),	#northeast
			point + Vector2(0,1)	#southeast
		])
...
func _recalculate_path():
	...
	print("starting at index: ", start_point_index, " which is at coords: ", path_start_position)
	print("ending at index: ", end_point_index, " which is at coords: ", path_end_position)
